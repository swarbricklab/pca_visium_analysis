...
analysis = "10_colocalisation_major"
...
for (section_name in unique(samples_config_sub$section_name)){
  ...
  prop_df <- read.csv(paste0("/share/ScratchGeneral/evaapo/projects/PCa_Visium/pca_visium_analysis/results/02_cell2location/06a_cell_type_mapping_major/", section_name, "/objects/q05_cell_abundance_w_sf.csv"))
