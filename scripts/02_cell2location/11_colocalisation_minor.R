...
# order of sample ids
desired_order = c('P11-1', 'P13-2', 'P4-1', 'P2-2', 'P10-2', 'P10-1', 'P25', 'P3-1', 'P4-2', 'P15-2')
...
anno_cols <- list(
  type = c("cancer" = "#9065CF",      
           "adj_benign" = "#E0B57C"), 
  # sample_id = c("P11-1" = "#FBB4AE", # pastel pink
  #               "P15-2" = "#B3CDE3", # pastel blue
  #               "P2-2" = "#CCEBC5", # pastel green
  #               "P25" = "#DECBE4",   # pastel lavender
  #               "P4-2" = "#FED9A6", # pastel orange
  #               "P10-2" = "#FFFFCC", # pastel yellow
  #               "P10-1" = "#E5D8BD", # pastel beige
  #               "P13-2" = "#FDDAEC", # pastel magenta
  #               "P4-1" = "#F2F2F2", # light grey
  #               "P3-1" = "#CCEBC5"  # pastel green
  #),
