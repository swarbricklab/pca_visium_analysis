...
analysis = "02_colocalisation_minor"
...
minor_csv_files <- grep("mapping/", csv_files, value = TRUE)
...
desired_order = c('20111-2', '20153-2', '20130-2', 'V1_2', '20033', '20216-1', '19617-2', "H1_4", "H1_2", "H2_1", "H2_2", "H2_5", "H1_5")
